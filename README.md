...
Tickets known to be discontinued (deliberately *not* added back, even though they disappeared from the scrape in the same 2026-06-07 to 2026-06-21 window as the ones above): `cumbria-day-ranger`, `cumbria-round-robin`, `cumbrian-coast-day-ranger`, `hadrians-wall-country-line-day-ranger`, `lakes-day-ranger`, `settle-carlisle-line-day-ranger`. Their detail pages either now 404 or return zero pricing tiers, and Northern publicly launched a replacement, the "Cumbria Travel Pass" (£40/day, £99/3 days; covers Northern, TransPennine Express and Avanti trains plus some Stagecoach buses and Windermere Lake Cruises boats), confirmed via [RailAdvent](https://www.railadvent.co.uk/2026/06/northern-launch-new-cumbria-travel-pass.html) and [Northern's own press release](https://media.northernrailway.co.uk/news/northern-preparing-for-lake-district-tourism-boom-as-it-introduces-new-ticket-valid-on-trains-buses-and-boats). Not yet added to this map: as of 2026-06-21 it isn't on nationalrail.co.uk (it 404s there) and is only sold via Northern's own `travelpass.northernrailway.co.uk`, which has no published station list, zone map, or child/railcard pricing -- add it via `add_tickets` once that data exists rather than guessing at coverage for a real ticket
